        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              <thead>
              <tr>
                <th class="px-6 py-3 bg-gray-50 text-left">Product</th>
                <th class="px-6 py-3 bg-gray-50 text-right">Revenue</th>
                <th class="px-6 py-3 bg-gray-50 text-right">Profit Margin</th>
                <th class="px-6 py-3 bg-gray-50 text-right">Rating</th>
              </tr>
              </thead>
...
import PricingTrendChart from '../../Components/PricingTrendChart.vue'
