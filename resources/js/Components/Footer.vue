                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul class="mt-4 space-y-4">
                                <li>
                                    <Link href="/products" class="text-base text-gray-300 hover:text-white">
                                        All Products
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/categories" class="text-base text-gray-300 hover:text-white">
                                        Categories
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/deals" class="text-base text-gray-300 hover:text-white">
                                        Deals
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div class="mt-12 md:mt-0">
                            ...
                            <ul class="mt-4 space-y-4">
                                <li>
                                    <Link href="/faq" class="text-base text-gray-300 hover:text-white">
                                        FAQ
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/shipping" class="text-base text-gray-300 hover:text-white">
                                        Shipping
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/returns" class="text-base text-gray-300 hover:text-white">
                                        Returns
                                    </Link>
                                </li>
                            </ul>
